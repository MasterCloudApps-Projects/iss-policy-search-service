...
class FindPolicyQueryHandlerTest {
	...
	void shouldBeFindAll() {
		...
		when(findPolicyPort.findAll(QUERY_TEXT)).thenReturn(list);
		...
		// then
		verify(findPolicyPort).findAll(QUERY_TEXT);
